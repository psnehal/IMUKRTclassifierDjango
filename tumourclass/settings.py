"""
Django settings for tumourclass project.
...
SECRET_KEY = 'django-insecure-%%-#c%vvndy-mo#w#k&7a+%4kvmqc50r#$$-x!n9t5nqa*l$+%'
...
WSGI_APPLICATION = 'tumourclass.wsgi.application'
